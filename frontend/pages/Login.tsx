...
const Login = () => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center py-24 px-6 bg-[#054231] relative z-10">
            ...
            <div className="bg-[#054231] rounded-[2.5rem] shadow-2xl border border-emerald-800/30 w-full max-w-5xl flex flex-col md:flex-row overflow-hidden relative z-10">
                {/* Visual Side */}
                <div className="md:w-1/2 bg-emerald-900 relative hidden md:block overflow-hidden p-12 flex flex-col justify-end">
                    ...
                    <div className="relative z-10 space-y-4 text-[#F8F9FA]">
                        <div className="inline-flex items-center gap-2 p-2 bg-[#106B53]/30 rounded-xl backdrop-blur-md border border-emerald-500/40 mb-4">
                            <ICONS.Leaf className="w-5 h-5 text-emerald-300" />
                            <span className="text-xs font-bold uppercase tracking-widest text-[#CFE5DA] pr-2">EcoImpact AI</span>
                        </div>
                        <h2 className="text-4xl serif italic leading-tight">Welcome to the<br />new standard.</h2>
                        <p className="text-[#CFE5DA]/80 font-medium max-w-sm">Access your environmental telemetry dashboard and own your carbon ledger.</p>
                    </div>
                </div>
                ...
                <div className="md:w-1/2 p-10 md:p-14 flex flex-col justify-center bg-[#054231] relative">
                    <div className="text-center mb-10">
                        ...
                        <h2 className="text-3xl serif italic text-[#F8F9FA]">Welcome Back</h2>
                        <p className="text-[#CFE5DA] text-sm mt-2 font-medium">Sign in to your account</p>
                    </div>
                    ...
                    <div className="mt-10 text-center text-sm font-medium text-[#9FC7B7] pt-6 border-t border-emerald-500/20">
                        Don't have an account? <Link to="/register" className="text-emerald-400 font-bold hover:text-emerald-300 hover:underline underline-offset-4 transition-colors">Create one now</Link>
                    </div>
                </div>
            </div>
        </div>
